...
GOOGLE_CREDS_B64 = os.environ["GOOGLE_CREDS_B64"]  # Service account JSON encode ជា base64
...
def main():
    sh = get_spreadsheet()
    queue_ws = get_or_create_worksheet(sh, "Queue", ["Index", "Code", "Status", "Result", "CheckedAt"])
